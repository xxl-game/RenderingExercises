Shader "AppsTools/FastShader/Effect/Blend_TwoSidesCopy"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 lerp1 = lerpResult91 * _Emission * i.vertexColor * i.vertexColor.a * tex2DNode105;
			float4 lerp2 = (lerpResult91 + _FresnelColor * tex2DNode105 * _SeparateEmission) * _Emission * i.vertexColor * i.vertexColor.a;
			float3 lerpResult = lerp(lerp1, lerp2, _SeparateFresnel).rgb;
			o.Emission = lerpResult;
			o.Alpha = 1;
